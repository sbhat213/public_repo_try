...
def test_save_delta_file():
    ...
    step_param.data_frame.write = mock.Mock()
    step_param.data_frame.write.format = mock.Mock()
    injector.get("SaveDeltaTable").execute(step_param)

    assert 1 == step_param.data_frame.write.format.call_count
