...
process_config_dir_path = parent_dir + "\\job_config\\process_config\\clean_up"
print("process_config directory name " + process_config_dir_path)

model_dir_path = parent_dir + "\\job_config\\models\\clean_up"
...
transform_dir_path = parent_dir + "\\job_config\\transformation_job\\clean_up"
